# -*- coding: utf-8 -*-
"""
Created on Tue Apr  7 21:05:32 2020
...
print(os.getcwd())
##project_dir = "C:/My_projects/BERT/Sentiment_analysis_imdb/logs"
##log_dir = str(os.getcwd)+ "/log/movie_reviews" + datetime.datetime.now().strftime("%Y%m%d-%H%M%s")
log_dir = "C:/My_projects/BERT/Sentiment_analysis_imdb/logs"

##log_dir = os.path.join(project_dir,"log_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%s"))
...
model.save_weights('C:/My_projects/BERT/Sentiment_analysis_imdb/trained_model/movie_reviews.h5', overwrite=True)
